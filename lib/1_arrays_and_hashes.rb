...
def first_two_elements(elements = [])
  return elements[0,2]
end
...
def first_three_elements(elements = [])
  return elements[0..2]
end
...
def i_joined_the_beatles(name)
  members = ["john", "paul", "george", "ringo", name]
  return members
end
...
def remove_nils_from_array(elements=[])
...
def new_vocalist(new)
  band_members = {'vocalist' => 'miss piggy', 'lead_guitar' => 'scooter'}
  band_members['vocalist'] = new
  return band_members
end
